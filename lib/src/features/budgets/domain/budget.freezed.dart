...
abstract class $BudgetCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String category, double limit, String month});
}
...
class _$BudgetImpl implements _Budget {
  ...
  @override
  String toString() {
    return 'Budget(id: $id, category: $category, limit: $limit, month: $month)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, category, limit, month);
...
abstract class _Budget implements Budget {
  const factory _Budget(
      ...
      required final String month}) = _$BudgetImpl;
