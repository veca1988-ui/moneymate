              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: Sizes.p8),
                    const _ComparisonRow(feature: 'Expenses', free: '50/month', premium: 'Unlimited'),
                    const _ComparisonRow(feature: 'Reports', free: 'Current month', premium: 'All history'),
                    const _ComparisonRow(feature: 'Categories', free: 'All 8', premium: 'All + Custom'),
                    const _ComparisonRow(feature: 'CSV Export', free: '—', premium: '✓'),
                    const _ComparisonRow(feature: 'Budget Alerts', free: '—', premium: '✓'),
                  ],
                ),
              ),
            ),
